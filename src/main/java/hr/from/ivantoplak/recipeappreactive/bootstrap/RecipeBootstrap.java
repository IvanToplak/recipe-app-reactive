package hr.from.ivantoplak.recipeappreactive.bootstrap;

import hr.from.ivantoplak.recipeappreactive.domain.*;
import hr.from.ivantoplak.recipeappreactive.repositories.CategoryRepository;
import hr.from.ivantoplak.recipeappreactive.repositories.RecipeRepository;
import hr.from.ivantoplak.recipeappreactive.repositories.UnitOfMeasureRepository;
